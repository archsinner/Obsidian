...
A _test double_ is the general programming concept for a type used in place of another type during testing. _Mock objects_ are specific types of test doubles that record what happens during a test so you can assert that the correct actions took place.
