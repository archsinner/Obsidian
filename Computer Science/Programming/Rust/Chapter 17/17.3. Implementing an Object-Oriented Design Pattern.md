...
The _state pattern_ is an object-oriented design pattern. The crux of the pattern is that a value has some internal state, which is represented by a set of _state objects_, and the value’s behavior changes based on the internal state. The state objects share functionality: in Rust, of course, we use structs and traits rather than objects and inheritance. Each state object is responsible for its own behavior and for governing when it should change into another state. The value that holds a state object knows nothing about the different behavior of the states or when to transition between states.
...
### [Storing the Text of the Post Content](https://doc.rust-lang.org/book/ch17-03-oo-design-patterns.html#storing-the-text-of-the-post-content)
...
### [Adding the `approve` Method that Changes the Behavior of `content`](https://doc.rust-lang.org/book/ch17-03-oo-design-patterns.html#adding-the-approve-method-that-changes-the-behavior-of-content)
