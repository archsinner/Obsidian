...
Recall from “Handling Potential Failure with the `Result` Type”  section in [[2. Programming a Guessing Game]] that the `Result` enum is defined as having two variants, `Ok` and `Err`, as follows:
...
[](https://doc.rust-lang.org/book/ch09-01-unrecoverable-errors-with-panic.html "Previous chapter")[](https://doc.rust-lang.org/book/ch09-03-to-panic-or-not-to-panic.html "Next chapter")